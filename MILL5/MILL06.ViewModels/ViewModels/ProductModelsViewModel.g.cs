// <auto-generated>
//     Generated from ProductModel.g.cs by the ViewModelsProject template.
...
namespace MILL06.ViewModels
{
    public partial class ProductModelsViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<ProductModel> ProductModels => MainViewModel.Instance.MainModel.ProductModels;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadProductModelsCommand'
        [RelayCommand]
        private async Task LoadProductModelsAsync()
        {
            await ProductModel.LoadAllAsync();
