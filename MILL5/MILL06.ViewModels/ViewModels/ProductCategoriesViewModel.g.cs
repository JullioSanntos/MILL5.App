// <auto-generated>
//     Generated from ProductCategory.g.cs by the ViewModelsProject template.
...
namespace MILL06.ViewModels
{
    public partial class ProductCategoriesViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<ProductCategory> ProductCategories => MainViewModel.Instance.MainModel.ProductCategories;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadProductCategoriesCommand'
        [RelayCommand]
        private async Task LoadProductCategoriesAsync()
        {
            await ProductCategory.LoadAllAsync();
