// <auto-generated>
//     Generated from SalesPerson.g.cs by the ViewModelsProject template.
...
{
    public partial class SalesPersonsViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<SalesPerson> SalesPersons => MainViewModel.Instance.MainModel.SalesPersons;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadSalesPersonsCommand'
        [RelayCommand]
        private async Task LoadSalesPersonsAsync()
        {
            await SalesPerson.LoadAllAsync();
