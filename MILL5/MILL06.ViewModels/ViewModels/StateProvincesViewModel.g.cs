// <auto-generated>
//     Generated from StateProvince.g.cs by the ViewModelsProject template.
...
{
    public partial class StateProvincesViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<StateProvince> StateProvinces => MainViewModel.Instance.MainModel.StateProvinces;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadStateProvincesCommand'
        [RelayCommand]
        private async Task LoadStateProvincesAsync()
        {
            await StateProvince.LoadAllAsync();
