// <auto-generated>
//     Generated from Illustration.g.cs by the ViewModelsProject template.
...
{
    public partial class IllustrationsViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<Illustration> Illustrations => MainViewModel.Instance.MainModel.Illustrations;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadIllustrationsCommand'
        [RelayCommand]
        private async Task LoadIllustrationsAsync()
        {
            await Illustration.LoadAllAsync();
