// <auto-generated>
//     Generated from EmailAddress.g.cs by the ViewModelsProject template.
...
{
    public partial class EmailAddressesViewModel : RegionBaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<EmailAddress> EmailAddresses => MainViewModel.Instance.MainModel.EmailAddresses;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadEmailAddressesCommand'
        [RelayCommand]
        private async Task LoadEmailAddressesAsync()
        {
            await EmailAddress.LoadAllAsync();
