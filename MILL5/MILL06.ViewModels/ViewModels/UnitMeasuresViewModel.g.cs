// <auto-generated>
//     Generated from UnitMeasure.g.cs by the ViewModelsProject template.
...
{
    public partial class UnitMeasuresViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<UnitMeasure> UnitMeasures => MainViewModel.Instance.MainModel.UnitMeasures;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadUnitMeasuresCommand'
        [RelayCommand]
        private async Task LoadUnitMeasuresAsync()
        {
            await UnitMeasure.LoadAllAsync();
