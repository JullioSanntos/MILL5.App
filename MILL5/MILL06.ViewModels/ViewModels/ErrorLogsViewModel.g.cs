// <auto-generated>
//     Generated from ErrorLog.g.cs by the ViewModelsProject template.
...
namespace MILL06.ViewModels
{
    public partial class ErrorLogsViewModel : RegionBaseViewModel
    {
        ...
        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadErrorLogsCommand'
        [RelayCommand]
        private async Task LoadErrorLogsAsync()
        {
            await ErrorLog.LoadAllAsync();
