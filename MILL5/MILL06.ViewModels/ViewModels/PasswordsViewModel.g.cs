// <auto-generated>
//     Generated from Password.g.cs by the ViewModelsProject template.
...
{
    public partial class PasswordsViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<Password> Passwords => MainViewModel.Instance.MainModel.Passwords;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadPasswordsCommand'
        [RelayCommand]
        private async Task LoadPasswordsAsync()
        {
            await Password.LoadAllAsync();
