// <auto-generated>
//     Generated from SpecialOffer.g.cs by the ViewModelsProject template.
...
{
    public partial class SpecialOffersViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<SpecialOffer> SpecialOffers => MainViewModel.Instance.MainModel.SpecialOffers;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadSpecialOffersCommand'
        [RelayCommand]
        private async Task LoadSpecialOffersAsync()
        {
            await SpecialOffer.LoadAllAsync();
