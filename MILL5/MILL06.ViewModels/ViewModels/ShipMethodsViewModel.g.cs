// <auto-generated>
//     Generated from ShipMethod.g.cs by the ViewModelsProject template.
...
{
    public partial class ShipMethodsViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<ShipMethod> ShipMethods => MainViewModel.Instance.MainModel.ShipMethods;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadShipMethodsCommand'
        [RelayCommand]
        private async Task LoadShipMethodsAsync()
        {
            await ShipMethod.LoadAllAsync();
