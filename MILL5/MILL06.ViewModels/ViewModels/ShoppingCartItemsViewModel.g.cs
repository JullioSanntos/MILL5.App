// <auto-generated>
//     Generated from ShoppingCartItem.g.cs by the ViewModelsProject template.
...
{
    public partial class ShoppingCartItemsViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<ShoppingCartItem> ShoppingCartItems => MainViewModel.Instance.MainModel.ShoppingCartItems;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadShoppingCartItemsCommand'
        [RelayCommand]
        private async Task LoadShoppingCartItemsAsync()
        {
            await ShoppingCartItem.LoadAllAsync();
