// <auto-generated>
//     Generated from ProductInventory.g.cs by the ViewModelsProject template.
...
{
    public partial class ProductInventoriesViewModel : BaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<ProductInventory> ProductInventories => MainViewModel.Instance.MainModel.ProductInventories;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadProductInventoriesCommand'
        [RelayCommand]
        private async Task LoadProductInventoriesAsync()
        {
            await ProductInventory.LoadAllAsync();
