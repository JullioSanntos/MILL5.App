// <auto-generated>
//     Generated from CurrencyRate.g.cs by the ViewModelsProject template.
...
{
    public partial class CurrencyRatesViewModel : RegionBaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<CurrencyRate> CurrencyRates => MainViewModel.Instance.MainModel.CurrencyRates;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadCurrencyRatesCommand'
        [RelayCommand]
        private async Task LoadCurrencyRatesAsync()
        {
            await CurrencyRate.LoadAllAsync();
