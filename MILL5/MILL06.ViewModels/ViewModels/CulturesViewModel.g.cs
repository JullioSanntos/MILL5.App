// <auto-generated>
//     Generated from Culture.g.cs by the ViewModelsProject template.
...
{
    public partial class CulturesViewModel : RegionBaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<Culture> Cultures => MainViewModel.Instance.MainModel.Cultures;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadCulturesCommand'
        [RelayCommand]
        private async Task LoadCulturesAsync()
        {
            await Culture.LoadAllAsync();
