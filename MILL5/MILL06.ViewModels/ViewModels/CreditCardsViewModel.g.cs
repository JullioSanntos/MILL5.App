// <auto-generated>
//     Generated from CreditCard.g.cs by the ViewModelsProject template.
...
{
    public partial class CreditCardsViewModel : RegionBaseViewModel
    {
        // 1. Bridge the View to the MainModel's collection
        public ObservableCollection<CreditCard> CreditCards => MainViewModel.Instance.MainModel.CreditCards;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadCreditCardsCommand'
        [RelayCommand]
        private async Task LoadCreditCardsAsync()
        {
            await CreditCard.LoadAllAsync();
