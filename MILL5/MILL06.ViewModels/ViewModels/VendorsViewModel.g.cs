// <auto-generated>
//     Generated from Vendor.g.cs by the ViewModelsProject template.
...
namespace MILL06.ViewModels
{
    public partial class VendorsViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<Vendor> Vendors => MainViewModel.Instance.MainModel.Vendors;

        #region Commands
        // 2. The toolkit automatically generates an ICommand named 'LoadVendorsCommand'
        [RelayCommand]
        private async Task LoadVendorsAsync()
        {
            await Vendor.LoadAllAsync();
